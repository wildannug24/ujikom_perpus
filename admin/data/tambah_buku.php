                ...
                <div class="col-sm-7">
                    ...
                    <form action="t_buku.php" method="POST" enctype="multipart/form-data">
                        <div class="mb-1">
                            ...
                            <input type="text" name="judul" class="form-control" required id="exampleInputEmail1"
                        ...
                        <div class="mb-1">
                            ...
                            <input type="text" name="penulis" class="form-control" required id="exampleInputEmail1"
                                aria-describedby="emailHelp">
                        </div>
                        <div class="mb-1">
                            <label for="exampleInputEmail1" class="form-label">deskripsi</label>
                            <input type="text" name="deskripsi" class="form-control" required id="exampleInputEmail1"
                                aria-describedby="emailHelp">
                        </div>
                        <div class="row">
                            <div class="col">
                            ...
                            <div class="mb-3">
                                <label for="formFileMultiple" class="form-label">Upload Buku<span
