...
<div class="container">
    <div class="row" style="margin-top: 1rem;">
            ...
            <table class="table my-2">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="data/detail_peminjaman.php?id_peminjaman=<?php echo $d['id_peminjaman']; ?>"
                            ...
                            <a href="data/delete_pinjaman.php?id_peminjaman=<?php echo $d['id_peminjaman']; ?>"
        ...
        ?>
        <div class="modal fade" id="modalEditBuku<?= $row['id_peminjaman']; ?>" tabindex="-1"
